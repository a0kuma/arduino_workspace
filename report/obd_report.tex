...
\author{Raspberry Pi GPIO21 to Arduino D2}
\date{2026-06-07}
...
\[
  \text{Raspberry Pi BCM GPIO21} \rightarrow \text{Arduino D2}.
\]
...
The Arduino uses the Uno D2 external interrupt, matching the reference
receiver.  The packet decode state machine is otherwise kept equivalent to
the reference edge-duration logic.
...
\begin{verbatim}
READY toyota_obd1_receiver input=D2 serial=115200 bit_cell_ms=8
