#!/usr/bin/env python3
"""End-to-end Raspberry Pi GPIO21 -> Arduino D2 Toyota OBD1 loopback test."""
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the physical GPIO21-to-D2 loopback test.")
